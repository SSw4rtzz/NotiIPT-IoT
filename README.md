Aplicação React que gere dados de sensores (luz, humidade, temperatura) com ESP32. Utiliza WebSockets para dados em tempo real e interações com dispositivos. Tecnologias: C++, Docker, Node.js, React, Websockets
